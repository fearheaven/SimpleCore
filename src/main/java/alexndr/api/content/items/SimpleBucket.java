	...
	public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
        ...
        if (movingobjectposition == null) {
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (flag) {
                    if (!playerIn.canPlayerEdit(blockpos.offset(movingobjectposition.sideHit), 
                    ...
                    if (this.tryPlaceContainedLiquid(worldIn, blockpos1) && !playerIn.capabilities.isCreativeMode && this.bucketType.doesVariantExist(Blocks.air)) {
