...
public class IItemHandlerHelper 
{
	...
	private static void dropInventoryItems(World worldIn, double x, double y, double z, 
														  ItemStackHandler inventory)
	{
        for (int i = 0; i < inventory.getSlots(); ++i)
        {
            ItemStack itemstack = inventory.extractItem(i, inventory.getSlotLimit(i), false);
